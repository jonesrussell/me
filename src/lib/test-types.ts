 ...
 */
export type RenderableComponent<T extends BaseSvelteComponent> = new (options: {
	target: HTMLElement;
 ...
 */
export type TestRenderResult<T extends BaseSvelteComponent> = Omit<
	RenderResult<T>,
	'component'
> & {
	component: T;
 ...
 */
export type PartialProps<T extends BaseSvelteComponent> = Partial<
	ComponentProps<T>
>;
